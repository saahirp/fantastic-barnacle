...
doodlerec=quick_draw_data_set[random_number];
console.log(doodlerec);
timer_counter=0;
timer_check="";
drawn_sketch="";
answer_holder="";
score=0;
document.getElementById("sketchtobedrawnp").innerHTML = "Sketch to be drawn:".concat(doodlerec);
function setup()
{
...
function draw(){
    check_sketch();
    if(drawn_sketch == doodlerec){
        answer_holder = "set";
        score = score+1;
        document.getElementById("spanscore").innerHTML = "Score:".concat(score);
    }
}

function check_sketch(){
    timer_counter = timer_counter+1;
    document.getElementById("spantimer").innerHTML = "Timer: ".concat(timer_counter);
